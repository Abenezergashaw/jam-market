...
const pageTitle = computed(() => {
  if (route.path === '/cashier') return 'Dashboard'
  if (route.path.startsWith('/cashier/orders')) return 'Orders'
  if (route.path.startsWith('/cashier/products')) return 'Products'
  if (route.path.startsWith('/cashier/categories')) return 'Categories'
  return 'Cashier'
})
</script>
